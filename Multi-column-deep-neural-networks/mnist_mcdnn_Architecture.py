...
#Implementing multi column deep neural network model on mnist. The following 5 models belong to single implementation of mcdnn.
...
Y_res = list(y_res.argmax(axis = -1))
Id1 = list(range(1,28001))
dic1 = {'ImageId' : Id1 , 'label' : Y_res}
df2 = pd.DataFrame(data = dic1)
df2.to_csv('submission.csv')

# model achieves training set accuracy above 99% and test set accuracy of 99.54%
