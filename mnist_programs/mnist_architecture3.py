...
def model(X_t , y_t , X_te):
    model = Sequential()
    model.add(Conv2D(300 , (3,3) , activation = 'relu' , padding = 'same' , input_shape = (28,28,1)))
...
model(X_train , y_train , X_test) # model achieves training set accuracy of 99.34% and test set accuracy of 98.86%
